...
public class XposedInstallerHooker {
    ...
    public static void hookXposedInstaller(final ClassLoader classLoader) {
        ...
        deoptMethod(classLoader, "org.edxp.manager.ModulesFragment", "onActivityCreated", Bundle.class);
        deoptMethod(classLoader, "org.edxp.manager.ModulesFragment", "showMenu", Context.class, View.class, ApplicationInfo.class);
        deoptMethod(classLoader, "org.edxp.manager.StatusInstallerFragment", "onCreateView", LayoutInflater.class, ViewGroup.class, Bundle.class);
        deoptMethod(classLoader, "org.edxp.manager.util.ModuleUtil", "updateModulesList", boolean.class, View.class);
        ...
        try {
            ...
            XposedHelpers.findAndHookMethod("org.edxp.manager.XposedApp", classLoader, "onCreate", new XC_MethodHook() {
                @Override
            ...
            XposedHelpers.findAndHookMethod("org.edxp.manager.util.ModuleUtil", classLoader, "updateModulesList", boolean.class, View.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    final Object thisObject = param.thisObject;
                    synchronized (thisObject) {
            ...
            XposedHelpers.findAndHookMethod("org.edxp.manager.StatusInstallerFragment", classLoader, "getCanonicalFile", File.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
